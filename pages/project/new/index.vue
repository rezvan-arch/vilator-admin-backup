...
useHead({
  title: "پنل مدیریت | ساخت پروژه ",
});

// variables
const { projectStore, adminStore, typesStore } = useStore();
  ...
  projectStore
    ...
    .then((res) => {
      if (res.status == "success") {
        ...
        router.push(`/project/edit/${res.data.id}`);
        loading.value = false;
      }
    })
    .catch((err) => {
  ...
  <section class="projects__new">
    <div class="card">
      <div class="card__header">
        <h4 class="heading__title">اضافه کردن پروژه</h4>
      </div>
      <div class="card__body">
        <vForm v-slot="{ errors, handleSubmit }" as="">
          ...
          <div class="row">
            ...
            <div class="controls w-1/3">
              <label for="type">نوع پروژه</label>
              <v-select
