...
import { propertyStore } from "~~/store/admin/property/index";
...
<template>
  <section class="properties__trash">
    <div class="card">
      <div class="card__header">
        <h4 class="heading__title">لیست سطل زباله ملک ها</h4>
        <div class="heading__actions">
          <nuxt-link to="/property/new" class="btn btn-primary">
            <i class="fa-regular fa-plus"></i>
            ملک جدید
          </nuxt-link>
          <nuxt-link to="/property" class="btn btn-primary">
  ...
  <ConfirmModal
    v-if="deleteConfirm"
    msg="آیا از حذف همیشگی این ملک اطمینان دارید؟"
  ...
  <ConfirmModal
    v-if="restoreConfirm"
    msg="آیا از بازگردانی این ملک اطمینان دارید؟"
